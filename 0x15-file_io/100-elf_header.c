...
/**
 * _close - to close a file descriptor
 * @fd: file descriptor
 */
void _close(int fd)
{
...
/**
 * elf_magic - to print ELF magic
 * @buffer: Header of ELF
 */
...
/**
 * elf_version - to print ELF version
 * @buffer: Header of ELF
 */
...
/**
 * elf_abivers - to print ELF ABI version
 * @buffer: Header of ELF
 */
...
/**
 * elf_entry -to  print entry point address
 * @buffer: String
 * @bit_mode: 32x or 64x
 * @big_endian: Endianness
 */
...
/**
 * main - to copy content of a file to another file
